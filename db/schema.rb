...
ActiveRecord::Schema.define(:version => 20120914223148) do
  ...
  add_index "invitations", ["event_id", "uploader_id"], :name => "index_invitations_on_event_id_and_uploader_id", :unique => true
